...
- {model}_{dataset}_transfer_{META_TASK}_activations.npz: Meta task activations
...
# Will load: {INPUT_BASE_NAME}_transfer_{META_TASK}_activations.npz
...
def main():
    ...
    activations_path = OUTPUT_DIR / f"{INPUT_BASE_NAME}_transfer_{META_TASK}_activations.npz"
